...
private:
    ...
    void should_return_gridsize_when_pawns_are_correctly_set_in_row();
    void should_return_gridsize_when_testing_rows_with_pawns_set_in_column();
    ...
    void should_return_gridsize_when_testing_columns_with_pawns_set_in_row();

    void should_return_gridsize_when_all_rows_are_balanced();
    void should_return_row_when_it_is_unbalanced();
